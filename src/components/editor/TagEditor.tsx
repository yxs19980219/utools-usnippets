...
export function TagEditor({
  ...
  return (
    <div ref={containerRef} className="relative flex min-w-0 flex-1 flex-wrap items-center gap-1">
      {tags.map((tag) => (
        <span
          key={tag}
          className="flex items-center gap-1 rounded-md bg-blue-600/10 px-1.5 py-0.5 text-xs text-blue-600 dark:bg-blue-500/20 dark:text-blue-400"
        >
